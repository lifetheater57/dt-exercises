...
class LaneControllerNode(DTROS):
    ...
    def __init__(self, node_name):
        ...
        self.sub_segment_list = rospy.Subscriber(f"/{veh}/ground_projection_node/lineseglist_out",
        ...
        self.count = 0
        print("d,phi,target_x,target_y,seg_min_dist,seg_max_dist,cluster_x,cluster_y,cluster_c,cluster_pos_mean_x,cluster_pos_mean_y,cluster_n_mean_x,cluster_n_mean_y,lane_mid_x,lane_mid_y,v,w,seg_list_size,cluster_size")
    ...
    def getControlValues(self, target):
        ...
        v = 0.3#v_min + np.power(cos_alpha, 2) * v_range
